<template>
  <div class="home">
    ...
    <el-pagination :page-size="pageSize" :pager-count="11" layout="prev, pager, next" :total="num" @current-change="currentChange"
      ...
      <div class="from-data">
        <el-form label-width="80px">
          ...
          <el-form-item label="图片">
            <el-upload class="upload-demo" action="http://localhost:3000/upload" style="text-align:left" :on-success="imageSuccessed" :file-list="fileList" list-type="picture">
...
export default {
  ...
  methods: {
    ...
    imageSuccessed: function(response, file, list) {
    ...
    currentChange(val) {
      this.dataInfo(this.pageSize,val)
      console.log(val);
    }
  },
  mounted() {
    this.dataInfo(this.pageSize,this.pageIndex)
  }
};
</script>
